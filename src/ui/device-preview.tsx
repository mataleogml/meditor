...
export function DevicePreview({
  ...
  return (
    <div className="flex min-h-0 flex-1 flex-col bg-[var(--scms-muted)]">
      <div className="flex items-center gap-1 border-b border-[var(--scms-border)] bg-[var(--scms-bg)] px-2 py-1.5">
        <div className="flex flex-1 items-center justify-center gap-1">
          ...
          <span className="ml-2 w-14 text-xs text-[var(--scms-muted-fg)]">
        ...
        <button
          ...
          className="inline-flex items-center gap-1.5 rounded-md px-2.5 py-1 text-xs font-medium text-[var(--scms-muted-fg)] transition-colors hover:bg-[var(--scms-muted)] hover:text-[var(--scms-fg)]"
        >
      ...
      <ScrollArea ref={areaRef} className="flex min-h-0 flex-1 justify-center p-0 md:p-4">
        <div
          className={cn(
            ...
            framed ? "shrink-0 overflow-hidden rounded-xl border border-[var(--scms-border)] shadow-lg" : "w-full"
          )}
        ...
        >
          ...
          {framed && (
            ...
            >
              <div className="mx-auto h-full w-0.5 bg-[var(--scms-border)] opacity-0 transition-opacity hover:opacity-100" />
            </div>
          )}
        </div>
      </ScrollArea>
